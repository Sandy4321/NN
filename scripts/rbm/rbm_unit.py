...
print "Mean:", m[0], "empirical mean:", np.average(rbm.bern_samp(m[0] * np.ones((n,1)),n))
print "Mean:", m[1], "empirical mean:", np.average(rbm.bern_samp(m[1] * np.ones((n,1)),n))
print "Mean:", m[2], "empirical mean:", np.average(rbm.bern_samp(m[2] * np.ones((n,1)),n))
print "Mean:", m[3], "empirical mean:", np.average(rbm.bern_samp(m[3] * np.ones((n,1)),n))
print "Mean:", m[4], "empirical mean:", np.average(rbm.bern_samp(m[4] * np.ones((n,1)),n))
print "Mean:", m[5], "empirical mean:", np.average(rbm.bern_samp(m[5] * np.ones((n,1)),n))
